...
export default function TreeView({
  ...
  function handleTreeSelect(event, node = {}) {
    ...
    if (multiselect && (event.metaKey || event.ctrlKey || showCheckbox)) {
...
TreeView.propTypes = {
  ...
  /**
   * **[Experimental]** Specify whether to show checkbox for node selection.
   * If `multiselect` is `false` then showCheckbox will not have any significance
   */
  showCheckbox: PropTypes.bool,

  /**
   * **[Experimental]** Specify whether to parent node is selectable or not.
   */
